                            ...
                            <tbody>
                                <?php foreach($checkpoints as $ind => $checkpoint) { ?>
                                    <tr>
                                        ...
                                        ?>
                                        <td colspan="<?php echo $cols; ?>" style="<?php echo $bg; ?>">
                                        <?php 
                                        ...
                                        for($i = 1; $i <= $cols; $i++) { 
                                            ...
                                            if(@$result1[$i-1] != '' && @$result1[$i-1] != NULL) {
                                                if($result1[$i-1] < $checkpoint['lsl'] || $result1[$i-1] > $checkpoint['usl']){
                                                    $bg = 'background-color:red';
                                                }
                                            }
                                            ?>
                                            <td style="text-align:center;<?php echo $bg; ?>"><?php if(@$result1[$i-1] != '' && @$result1[$i-1] != NULL) {
                                                echo $result1[$i-1];
                                            }else{
